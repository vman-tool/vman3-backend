...
#         va_data_csv =get_data("vacheck","probbaseV5.csv")
#         print(va_data_csv)
#         randomVA5 = read_csv(BytesIO(va_data_csv))
#         print("randomVA5", randomVA5.columns)
#         print("probbaseV5", probbaseV5[:, 0:17])
#         print("va_input_names", va_input_names)
...
#                    asyncio.run(self.update_callback({"progress": progress,"message": "Running InterVA5 analysis...","elapsed_time": elapsed_time,"error": False, "total_records":self.va_input.shape[0]}))
...
#     example_input_bytes = get_data("interva","randomva5.csv")
...
#     if version == "19":
#         # Get current file's directory: /.../interva/
...
def get_example_input() -> DataFrame:
    ...
    example_input_bytes = get_data(__name__, "randomva5.csv")
    example_input = read_csv(BytesIO(example_input_bytes))
    return example_input
