...
from app.shared.configs.email import send_email
from app.shared.configs.settings import get_settings
from app.users.models.user import User
from app.users.utils.email_context import FORGOT_PASSWORD, USER_VERIFY_ACCOUNT

settings = get_settings()


async def send_account_verification_email(user: User, background_tasks: BackgroundTasks):
    from app.shared.configs.security import hash_password
