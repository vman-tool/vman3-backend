...
from app.pcva.requests.icd10 import ICD10CategoryRequestClass
from app.pcva.services.icd10_services import create_icd10_categories
...
@pcva_router.post("/create-icd10-category", status_code=status.HTTP_201_CREATED)
async def get_va_records(
    ...
    try:
        ...
        raise HTTPException(status.HTTP_500_INTERNAL_SERVER_ERROR, detail="Failed create icd10 category")